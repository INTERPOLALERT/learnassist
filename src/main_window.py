...
class MainWindow(QMainWindow):
    ...
    def _create_sidebar(self) -> QWidget:
        ...
        # User info at bottom
        user_info = QLabel(f"üë§ {self.user_id}")
    ...
    def _create_toolbar(self):
        ...
        # Quick actions
        new_btn = QPushButton("ï New")
        new_btn.clicked.connect(self._new_assignment)
        toolbar.addWidget(new_btn)

        toolbar.addSeparator()

        timer_btn = QPushButton("Ò Start Timer")
    ...
    def _load_views(self):
        ...
        try:
            ...
            self._add_placeholder_view("Study Timer", "Ò Study Timer View\n\nComing soon...")
            self._add_placeholder_view("Notes", "=› Notes View\n\nComing soon...")
            self._add_placeholder_view("Calendar", "=≈ Calendar View\n\nComing soon...")
            self._add_placeholder_view("AI Tools", "ü§ñ AI Tools View\n\nComing soon...")
